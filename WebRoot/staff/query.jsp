...
<body>
	...
	<form class="ui form" action="${basePath}user/query.action" method="post">
	...
	{
		window.location.href="${basePath}user/modify.action?userid="+userid;
	}
	function deleteuser(userid)
	{
		window.location.href="${basePath}user/delete.action?userid="+userid;
	}
	</script>
</body>
</html>
